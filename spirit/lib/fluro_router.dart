...
import 'package:spirit/pages/local_auth_page/local_auth_page.dart';
...
class MyFluroRouter {
  ...
  static Handler localauthHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) => const LocalAuthPage());
  ...
  static void setupRouter(){
    ...
    router.define(LocalAuthPage.routeName, handler: localauthHandler); //, transitionType: TransitionType.fadeIn); //, transitionDuration: const Duration(seconds: 1));
